document.addEventListener("DOMContentLoaded", () => {
    ...
    if (message !== "") {
    // Append the message to the chat container locally
    ...
    // Event listener for receiving a connection notification from the server
    socket.on("connected", (data) => {
    console.log("Received connection notification:", data.message);
    });
    
    // Event listener for receiving the number of connected users from the server
